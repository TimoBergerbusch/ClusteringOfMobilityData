#This implementation was copied from https://sourceforge.net/projects/gower-distance-4python/files/
import numpy as np
import pandas as pd
...
#print(data_collection_equal_dist)
