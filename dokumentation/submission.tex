...
\begin{document}
	...
	In this section we want to further improve the accuracy of predicting the strata of one person by using neural networks. Like in the previous section, when we used decision trees, we need ground truth, in this case the strata, to be able to train the neural networks. For all the neural net computations we considered person vector data sets of different sizes (c.f. \Cref{subsec: person vector data}).\\
